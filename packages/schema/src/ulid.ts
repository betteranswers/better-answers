 ...
 * sortable, not confidential. Each sorts after the last one this process minted, even when the
 * clock stands still or steps back.
 * @throws once the clock is past the 48-bit time half.
 */
