...
export default {
  ...
  // Never raise: restarting a worker discards the Postgres container its `globalSetup`
  // started, and every mutant after it pays a container start again.
  maxTestRunnerReuse: 0,

  // Each test runner process owns a Postgres container, and the hosted runner has four vCPUs.
  concurrency: 4,
};
