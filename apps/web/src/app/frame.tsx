...
/**
 * Control Centre's frame: the wordmark, the navigation over the six screens, and the
 * region a screen renders into.
 *
...
export function Frame() {
  return (
    <div className="flex min-h-screen bg-background">
      <a
        href="#screen"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-10 focus:bg-card focus:px-3 focus:py-2 focus:text-foreground focus:shadow-none"
      >
        Skip to the screen
      </a>

      <header className="flex w-sidebar shrink-0 flex-col gap-6 border-r border-border bg-sidebar px-4 py-5">
      ...
      */}
      <main id="screen" tabIndex={-1} className="flex-1 px-8 py-6">
