 ...
 *
 * It is a module of its own rather than a line in `mount.ts`, which is the tier's *internal*
 * interface — the mount, the endpoint constant, the dependency type — and a package entry that
 * exposed those would invite the SPA to reach for one of them. Here there is nothing
