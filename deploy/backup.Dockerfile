...
# (ADR 0022 A11, `[OPS1]`: a compose file refuses to start without a digest, and that rule
...
#
# What it carries: pg_dump 18 on the SAME base as the database (`[DEPS2]`: the one pinned
...
#
# Versions (`[DEPS1]`): pgvector 0.8.6-pg18-trixie by digest, read 01/09/2026 (the schema
