...
The rules files were founded on a short imperative form and drifted into narrative: enforcement bookkeeping, mechanism description and ticket history. An agent writes what it sees, and the same voice ran through the code.
