...
| S5 | api · web · Postgres · git store | `concepts` slice — the promotion gate, the by-run revert; the Suggestions screen (no stuck-ref act: T-108 closed 19/09/2026 with ADR 0012 saying why) |
